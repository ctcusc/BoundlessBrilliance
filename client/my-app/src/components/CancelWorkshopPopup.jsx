...
const CancelWorkshopPopup = ({setToggleState, setToggleYesState, name, user_id, workshop_id}) => {
    ...
    return (
        <div className="popup-center">
            <div className="popup-container">
                <p className="p-popup">You are <span style={{color: '#D90000'}}>declining</span> to attend:</p>
...
export default CancelWorkshopPopup